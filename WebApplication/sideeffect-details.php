...
<h2 style="text-align: center;">Details of <?php echo $sideeffect_name; ?></h2>
...
$result = mysqli_query($con,"select * from medical_new where condition_name ='".$condition_name."' and sideeffect like '%".$sideeffect_name."%' order by frequency desc,percentage_effected ");
