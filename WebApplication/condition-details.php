...
<h2 style="text-align: center;">Details of <?php echo $condition_name; ?></h2>
...
$result = mysqli_query($con,"select * from medical_new where condition_name ='".$condition_name."' order by frequency desc,drug,percentage_effected ");
