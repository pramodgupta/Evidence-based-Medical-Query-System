...
<h2 style="text-align: center;"> Search SideEffects</h2>
<br>	
 <ul>
      <li class="field" style="width: 68%;float: left;">
		<input type="text" name="query" value="Enter the side effects over here" />
      </li>
...
$result = mysqli_query($con,"select distinct condition_name from medical_new where sideeffect like '%".$search_text."%' order by frequency desc,percentage_effected ,condition_name, drug ");

//echo $result->num_rows;
while($row = $result->fetch_array())
  {
	echo "<tr>";
     echo "<td><a href='sideeffect-details.php?cname=".$row["condition_name"] ."&sef=".$search_text."'>".$row["condition_name"]."</a></td>";
